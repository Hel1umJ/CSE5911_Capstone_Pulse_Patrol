...
reconnect_happening = False # Flag to keep track of reconnect attempts
...
def update_vitals(root):
    ...
    """
    global t_step, time_since_print
    ...
    if time_since_print >= RECORD_INTERVAL:
        output_to_file(sensor_info)
        time_since_print = 0
    else:
        time_since_print += UPDATE_INTERVAL
